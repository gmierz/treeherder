...
class TelemetryBugManager(BugManager):
    ...
    def file_bug(self, probe, alert):
        ...
        needinfo_emails = probe.get_notification_emails(default="gmierzwinski@mozilla.com")
        # self._add_needinfo(needinfo_emails[0], bug_data)
        self._add_needinfo("gmierzwinski@mozilla.com", bug_data)
...
class TelemetryBugContent:
    ...
    def build_bug_content(self, alert):
        ...
        repo = CHANNEL_TO_REPO_MAPPING.get(alert.telemetry_signature.channel, "mozilla-central")
    ...
    def _build_probe_alert_row(self, alert):
        ...
        return (
            ...
            values=values,
            glean_dictionary_link=get_glean_dictionary_link(alert.telemetry_signature),
        )
