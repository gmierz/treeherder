...
from treeherder.perf.models import PerformanceTelemetryAlert, PerformanceTelemetryAlertSummary
...
class TelemetryAlertManager(AlertManager):
    ...
    def house_keeping(self, alerts, commented_bugs, new_bugs):
        ...
        Currently handles re-running email alerts for alerts whose emails
        had failed.
        """
